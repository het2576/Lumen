...
interface Props { documents: Document[]; selectedId: string | null; onSelect: (document: Document) => void; onUploaded: (document: Document) => void; onDeleted: (documentId: string) => void; loading: boolean; open: boolean; }
...
export default function Sidebar({ documents, selectedId, onSelect, onUploaded, onDeleted, loading, open }: Props) {
